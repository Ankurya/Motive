...
@section('pageContent')
		...
		<p><a href="{{url('dashboard')}}"> Home</a> <i class="ti-angle-right"></i><a href="{{url('music-list')}}"> Music Interest Management</a> <i class="ti-angle-right"></i>  <span>Add </span> </p>
		</div>
		</div>
        <div class="content">
		 @if($errors->any())
            ...
            <div class="container-fluid">
				<div class="row main-right-content card">
					<form action="{{url('add-music-interest')}}" class="main-content-form" method="post" >
						{{csrf_field()}}
						...
						<input type="submit" value="Add" class="btn btn-info btn-fill btn-wd btn-clr">
						</div>
					</form>
				</div>
        	</div>
