...
<div class="sidebar-wrapper">
            ...
            <ul class="nav">
 			   ...
 			   <li class="sub-menu @if(Request::is('private-events') || Request::is('private-view-event-details/*') || Request::is('edit-private-event-details/*') || Request::is('public-events')|| Request::is('private-view-event-details/*')|| Request::is('public-view-event-details/*') ) active open-menu @endif">
					 ...
					 <ul class="inner-menu">
                        ...
                        <li class="@if(Request::is('public-events')|| Request::is('public-view-event-details/*')|| Request::is('edit-public-events-details/*')) active @endif">
...
<?php //print_r($event_detail);die; ?>
		...
		<div class="container-fluid">
		<p><a href="{{url('dashboard')}}"> Home</a> <i class="ti-angle-right"></i> <a href="javascript:void(0);"> Event Management</a> <i class="ti-angle-right"></i> <a href="javascript:void(0);"> Private Events</a> <i class="ti-angle-right"></i> <span>Edit Event Details </span> </p>
		</div>
		</div>
		...
		@if($errors->any())
			...
			<form class="main-content-form" action="{{url('update_private_event')}}"  method="post" enctype="multipart/form-data">
				{{csrf_field()}}
					...
					<div class="form-group col-sm-6 col-xs-12">
                       <label>Public Category</label>
						...
						foreach($get_public_interest  as $get_public_interest){ ?>	
							<option value="{{$get_public_interest->id}}" <?php  if(strpos($public_cat_id,(string)$get_public_interest->id) !== false) echo "selected"; ?> >{{$get_public_interest->name}}</option>
						<?php }?>
						 </select>	   
