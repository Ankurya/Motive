...
<link rel="stylesheet" type="text/css" href="https://cdn.datatables.net/1.10.16/css/jquery.dataTables.css">
            ...
            <div class="custom-breadcrumb">
               <div class="container-fluid">
                  <p><a href="{{url('dashboard')}}"> Home</a> <i class="ti-angle-right"></i> <a href="javascript:void(0);"> Event Management</a> <i class="ti-angle-right"></i><a href="javascript:void(0);"> Private Events </a> <i class="ti-angle-right"></i> <span>Event List </span> </p>
               </div>
            </div>
            <div class="content">
			@if($errors->any())
                        ...
                        <table class="table table-striped card table-responsive" id="example" width="100%">
						   ...
						   @foreach($events as $events)
                              <tr>
								 ...
								 <td><a href="{{url('private-view-event-details/'.$events->id)}}" class="view_table">View </a> <a href="{{url('edit-private-event-details/'.$events->id)}}" class="table_block">Edit</a></td>
								 <!--<td><a href="{{url('private-events-schedule-list/'.$events->id)}}" class="view_table">View </a> <a href="{{url('edit-private-event-details/'.$events->id)}}" class="table_block">Edit</a></td>-->
