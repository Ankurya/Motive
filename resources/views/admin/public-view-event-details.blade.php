...
@section('pageContent')		
		...
		<p><a href="{{url('dashboard')}}"> Home</a> <i class="ti-angle-right"></i> <a href="javascript:void(0);"> Event Management</a> <i class="ti-angle-right"></i> <a href="javascript:void(0);"> Public Events</a> <i class="ti-angle-right"></i> <span>View Event Details </span> </p>
		</div>
		</div>
        ...
        <div class="content">
			...
			@if($event_detail->event_media_type == 1)
				...
				<div class="form-group col-sm-16 col-xs-12" >
					<div class="img-sec upload-pro-pic play-video">  
			...
			<div class="form-group col-sm-12 col-xs-12 main-form-update">
			 <!--<label class = " btn-info btn-fill btn-wd " style="background-color:#efc767;border-color:#efc767;width:10px;padding:10px; text-align:center;color:black"> @if($event_detail->status == 1)Not-Approved @else Approved @endif</label>-->
			<a href="{{url('edit_public_event/'.$event_detail->id)}}" class="view_table"><input type="button" value="Edit" class="btn btn-info btn-fill btn-wd btn-clr"></a>
			<a href="{{url('delete_public_event/'.$event_detail->id)}}" class="view_table"><input type="button" value="Delete" class="btn btn-info btn-fill btn-wd btn-clr btn-del"></a>
