...
<link rel="stylesheet" type="text/css" href="https://cdn.datatables.net/1.10.16/css/jquery.dataTables.css">
	<div class="custom-breadcrumb">
	   <div class="container-fluid">
		  <p><a href="{{url('dashboard')}}"> Home</a> <i class="ti-angle-right"></i> <a href="javascript:void(0);"> User Management</a> <i class="ti-angle-right"></i> <span>User List </span> </p>
	   </div>
	</div>
	<div class="content">
	    @if($errors->any())
					...
					<tbody>
					   @php($inc=1)
						...
						<tr>
							...
							<?php $refferal_count=DB::table('users')->where(['refferal_user_code'=>$user_list->refferal_code])->count(); ?>
							<td>{{$refferal_count}}</td>
							...
							<td><a href="{{url('view-user/'.$user_list->id)}}" class="view_table">View </a> <a href="{{url('block_unblock_user/'.$user_list->id)}}" class="table_block">@if($user_list->blockStatus == 1) Unblock @else Block @endif </a></td>
						</tr>
						@endforeach
