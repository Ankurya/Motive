...
">
    ...
    border-bottom-left-radius: 29px;">
                                ...
                                <tr>
                                    <td align="left" valign="top" style="font-family: 'Open Sans', sans-serif; font-size:18px; color:#474747; font-weight: 700;text-align:center;">Hello, Motiv Enterpriseuk MoTiv</td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    <td align="center" valign="top" style="font-family: 'Open Sans', sans-serif; font-size:18px; color:#2c2c2c;">
                                        <?php if(!empty($user_data->event_name)) echo $user_data->event_name; else echo'Facebook'; ?>
                                    </td>
                                </tr>
                                <tr>
                                    <td align="left" valign="top">&nbsp;</td>
                                ...
                                <tr>
                                    <td align="center" valign="top" style="font-family: 'Open Sans', sans-serif; font-size:18px; color:#2c2c2c; font-weight: 700;">
                                        <?php if(!empty($user_data->event_location)) echo $user_data->event_location; else echo'N/A'; ?>
                                    </td>
                                </tr>
                                <tr>
                                    <td align="left" valign="top">&nbsp;</td>
                                ...
                                <tr>
                                    ...
                                    <td align="center" valign="top" style="font-family: 'Open Sans', sans-serif; font-size:18px; color:#2c2c2c; font-weight: 700;">
                                        <?php if(!empty($user_data->event_date)) echo $user_data->event_date; else echo'N/A'; ?>
                                    </td>
                                </tr>
                                <tr>
                                    <td align="left" valign="top">&nbsp;</td>
                                ...
                                <tr>
                                    <td align="center" valign="top" style="font-family: 'Open Sans', sans-serif; font-size:18px; color:#2c2c2c; font-weight: 700;">
                                        <?php if(!empty($user_data->event_time)) echo $user_data->event_time; else echo'N/A'; ?>
                                    </td>
                                </tr>
                                <tr>
                                    <td align="left" valign="top">&nbsp;</td>
                                ...
                                <tr>
                                    <td align="center" valign="top" style="font-family: 'Open Sans', sans-serif; font-size:18px; color:#2c2c2c; font-weight: 700;">
                                        <?php if(!empty($user_data->ticket_quantity->Quantity)) echo $user_data->ticket_quantity->Quantity; else echo'N/A'; ?>
                                    </td>
                                </tr>
                                <tr>
                                    <td align="left" valign="top">&nbsp;</td>
