...
">
    ...
    border-bottom-left-radius: 29px;">
                                ...
                                <tr>
                                    <td align="left" valign="top" style="font-family: 'Open Sans', sans-serif; font-size:18px; color:#474747; font-weight: 700;text-align:center;">Hello, {{$user_data->user_name ?? 'N/A'}}</td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    <td align="center" valign="top" style="font-family: 'Open Sans', sans-serif; font-size:18px; color:#ff8a00; text-transform: uppercase; font-weight: 700;">Revenue Details</td>
                                </tr>
                                <tr>
                                    <td height="10" align="left" valign="top"></td>
                                </tr>
                                ...
                                <tr>
                                    <td align="center" valign="top" style="font-family: 'Open Sans', sans-serif; font-size:18px; color:#2c2c2c;">
                                        <?php if(!empty($user_data->event_list->event_name)) echo $user_data->event_list->event_name; else echo'Facebook'; ?>
                                    </td>
                                </tr>
                                <tr>
                                    <td align="left" valign="top">&nbsp;</td>
                                ...
                                <tr>
                                    <td align="center" valign="top" style="font-family: 'Open Sans', sans-serif; font-size:18px; color:#2c2c2c; font-weight: 700;">
                                        <?php if(!empty($user_data->event_list->event_location)) echo $user_data->event_list->event_location; else echo'N/A'; ?>
                                    </td>
                                </tr>
                                <tr>
                                    <td align="left" valign="top">&nbsp;</td>
                                ...
                                <tr>
                                    ...
                                    <td align="center" valign="top" style="font-family: 'Open Sans', sans-serif; font-size:18px; color:#2c2c2c; font-weight: 700;">
                                        <?php if(!empty($user_data->event_date2)) echo $user_data->event_date2; else echo'N/A'; ?>
                                    </td>
                                </tr>
                                <tr>
                                    <td align="left" valign="top">&nbsp;</td>
                                ...
                                <tr>
                                    <td align="center" valign="top" style="font-family: 'Open Sans', sans-serif; font-size:18px; color:#2c2c2c; font-weight: 700;">
                                        <?php if(!empty($user_data->event_time)) echo date('h:i a', strtotime($user_data->event_time));  else echo'N/A'; ?>
                                    </td>
                                </tr>
                                <tr>
                                    <td align="left" valign="top">&nbsp;</td>
                                ...
                                <tr>
                                    <td align="center" valign="top" style="font-family: 'Open Sans', sans-serif; font-size:16px; color:#ff8a00;">Event Revenue</td>
                                </tr>
                                <tr>
                                    <td align="center" valign="top" style="font-family: 'Open Sans', sans-serif; font-size:18px; color:#2c2c2c; font-weight: 700;">
                                        <?php if(!empty($user_data->ticket_amount->Amount)) echo "£".$user_data->ticket_amount->Amount; else echo'N/A'; ?>
                                    </td>
                                </tr>
                                <tr>
                                    <td align="left" valign="top">&nbsp;</td>
                                ...
                                <tr>
                                    <td align="center" valign="top" style="font-family: 'Open Sans', sans-serif; font-size:16px; color:#ff8a00;">User Ticket Sale</td>
                                </tr>
                                <tr>
                                    <td align="center" valign="top" style="font-family: 'Open Sans', sans-serif; font-size:18px; color:#2c2c2c; font-weight: 700;">
                                        <?php if(!empty($user_data->normalUser->normalUser)) echo $user_data->normalUser->normalUser; else echo'N/A'; ?>
                                    </td>
                                </tr>
                                <tr>
                                    <td align="center" valign="top" style="font-family: 'Open Sans', sans-serif; font-size:16px; color:#ff8a00;">Guest Ticket Sale</td>
                                </tr>
                                <tr>
                                    <td align="center" valign="top" style="font-family: 'Open Sans', sans-serif; font-size:18px; color:#2c2c2c; font-weight: 700;">
                                        <?php if(!empty($user_data->guestUser->guestUser)) echo $user_data->guestUser->guestUser; else echo'N/A'; ?>
                                    </td>
                                </tr>
                                <tr>
                                    <td align="center" valign="top" style="font-family: 'Open Sans', sans-serif; font-size:16px; color:#ff8a00;">Total Ticket Sales</td>
                                </tr>
                                <tr>
                                    <td align="center" valign="top" style="font-family: 'Open Sans', sans-serif; font-size:18px; color:#2c2c2c; font-weight: 700;">
                                        <?php if(!empty($user_data->total_ticket)) echo $user_data->total_ticket; else echo'N/A'; ?>
                                    </td>
                                </tr>
                                <tr>
                                    <td align="left" valign="top">&nbsp;</td>
        ...
        <tr>
            <td align="left" valign="top" style="background:#f3f3f3; padding:20px; text-align:center;">
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    ...
                    <tr>
                        <td align="center" valign="top" style="font-family:arial, sans-serif; font-size:13px; color:#727272; padding-top:10px;">© MoTiv
