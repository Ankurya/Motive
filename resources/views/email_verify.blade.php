...
">
  ...
  <tr>
    ...
    border-bottom-left-radius: 29px;">
          ...
          <tr>
            <td align="left" valign="top" style="font-family:arial, sans-serif; font-size:22px; color:#474747; font-weight: 700;text-align:center;">Hello, <?php if(!empty($user_data['name'])) echo $user_data['name']; else echo'User'; ?></td>
          </tr>
          <tr>
            <td align="center" valign="top" style="font-family:arial, sans-serif; font-size:15px; color:#474747;">Thank you for downloading our app,please verify<br> your email address</td>
          </tr>
          <tr>
          ...
          <tr>
            <td align="center" valign="top"><a href="{{ $url }}"; style="font-family:arial, sans-serif; font-size:22px; color:#474747; background-color: #f5bd12; padding: 12px 50px; max-width: 375px; display: block; text-align: center; margin: 0 auto; color: #fff; text-decoration: none; border-radius: 30px; box-shadow: 0 0px 5px #efba19 ;     border-bottom: 3px solid #daaa16;     font-weight: 700;">Verify your  email address </a></td>
          </tr>
           <tr>
            <td align="left" valign="top">&nbsp;</td>
          </tr>
          ...
          <tr>
            <td align="center" valign="top" style="font-family:arial, sans-serif; font-size:12px; color:#474747;">Or</td>
          </tr>

          <tr>
            <td align="center" valign="top" style="font-family:arial, sans-serif; font-size:12px; color:#474747;">{{ $url }}<br> Please copy this link to verify your email address</td>
          </tr>
          ...
          <tr>
            <td align="center" valign="top" style="font-family:arial, sans-serif; font-size:15px; color:#474747;">Best regards</td>
          </tr>
          <tr>
                  <td align="left" valign="top">&nbsp;</td>
                </tr>
          ...
          <tr>
            <td align="center" valign="top" style="font-family:arial, sans-serif; font-size:15px; color:#474747;">Yours Friends at MoTiv</td>
          </tr>
           <tr>
            <td align="left" valign="top">&nbsp;</td>
          </tr>
