...
">
  ...
  <tr>
    ...
    border-bottom-left-radius: 29px;">
          ...
          <tr>
            <td align="left" valign="top" style="font-family: 'Open Sans', sans-serif; font-size:18px; color:#474747; font-weight: 700;text-align:center;">Hello, {{$user->name}}</td>
          </tr>
           <tr>
          ...
          <tr>
            <td align="center" valign="top" style="font-family: 'Open Sans', sans-serif; font-size:16px; color:#ff8a00;">Your event has been approved by Admin. In order to proceed with this request.</td>
          </tr>
          ...
          <tr>
            ...
            <td align="center" valign="top" style="font-family: 'Open Sans', sans-serif; font-size:18px; color:#2c2c2c;"><a href="{{ $url }}"> Click here to submit your details for payment </a></td>
          </tr>
