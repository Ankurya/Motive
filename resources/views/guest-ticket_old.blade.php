    ...
    <td align="left" valign="top" style="background:#efefef; padding:30px 20px;"><table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td align="left" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
          ...
          <tr>
            <td style="">
              <h2 style="font-family:Arial, sans-serif, 'Helvetica Neue', Helvetica; font-size:23px;background:#efefef; color:#393939; font-weight:600; margin:0; padding-left: 17px; text-align: center;">Event Invitation
            ...
            <td style="">
              <h2 style="font-family:Arial, sans-serif, 'Helvetica Neue', Helvetica; font-size:20px;background:#efefef; color:#393939; font-weight:600; margin:0; padding-left: 17px;">
                Hello, <?php if(!empty($user_data['name'])) echo $user_data['name']; else echo'User'; ?>
          ...
          <tr >
            ...
            <span style="display: block;"> <b style="padding-left: 0px !important;">Event Name</b> : <?php if(!empty($user_data['name'])) echo $user_data['event_name']; else echo'User'; ?></span><br><br>
            <span style="display: block;"> <b style="padding-left: 0px !important;">Event Location</b> : <?php if(!empty($user_data['address'])) echo $user_data['address']; else echo'N/A'; ?> </span> <br><br>
           ...
           <!--  <span style="display: block;"><b style="padding-left: 0px !important;">Event End Time</b> :<?php if(!empty($user_data['end_time'])) echo $user_data['end_time']; else echo'N/A'; ?></span> <br><br> -->
            ...
            <span style="display: block;"><b style="padding-left: 0px !important;">Ticket Id</b> :<?php if(!empty($user_data['ticket_id'])) echo $user_data['ticket_id']; else echo'N/A'; ?></span> <br><br>
