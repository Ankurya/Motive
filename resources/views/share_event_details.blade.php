...
">
  ...
  <tr>
    ...
    border-bottom-left-radius: 29px;">
          ...
          <tr>
            <td align="left" valign="top" style="font-family: 'Open Sans', sans-serif; font-size:18px; color:#474747; font-weight: 700;text-align:center;">Hello, {{$event_share['user_name']}}</td>
          </tr>
           <tr>
          ...
          <tr>
            <td height="10" align="left" valignevent_share_url="top"></td>
          </tr>
          <tr>
            <td align="center" valign="top" style="font-family: 'Open Sans', sans-serif; font-size:18px; color:#ff8a00; text-transform: uppercase; font-weight: 700;">Please click below Link Event Details</td>
          </tr>
          <tr>
            <td height="10" align="left" valign="top"></td>
          </tr>
          ...
          <tr>
            <td align="center" valign="top" style="font-family: 'Open Sans', sans-serif; font-size:18px; color:#2c2c2c;"><a href="<?php echo $event_share['event_share_url'] ?>">Click Here For Event Details</a></td>
          </tr>
