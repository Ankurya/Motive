...
">
  ...
  <tr>
    ...
    border-bottom-left-radius: 29px;">
          ...
          <tr>
            <td align="left" valign="top" style="font-family:arial, sans-serif; font-size:22px; color:#474747; font-weight: 700;text-align:center;"></td>
          </tr>
          <tr>
            <td align="center" valign="top" style="font-family:arial, sans-serif; font-size:15px; color:#474747;">Thank you for subscribing us.</td>
          </tr>
          <tr>
