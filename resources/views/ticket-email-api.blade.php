...
">
  ...
  <tr>
    ...
    border-bottom-left-radius: 29px;">
          ...
          <tr>
            <td align="left" valign="top" style="font-family: 'Open Sans', sans-serif; font-size:18px; color:#474747; font-weight: 700;text-align:center;">Hello, {{$user_data->user_name ?? 'User'}}</td>
          </tr>
           <tr>
        ...
        <tr>
            <td align="center" valign="top" style="padding:20px 0;">
              @if($user_data->tickets)
                @foreach($user_data->tickets as $ticket)
                  <a href="#" style="border:0; outline:0;"><img src="{{$message->embed($ticket->qr_image)}}" alt="" width=""/></a>
                @endforeach
              @endif
        </td>
          </tr>
