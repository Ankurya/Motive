...
">
  ...
  <tr>
    ...
    border-bottom-left-radius: 29px;">
          ...
          <tr>
            <td align="left" valign="top" style="font-family: 'Open Sans', sans-serif; font-size:18px; color:#474747; font-weight: 700;text-align:center;">Hello, <?php if(!empty($user_data->guest_name)) echo $user_data->guest_name; else echo' '; ?></td>
          </tr>
           <tr>
          ...
          <tr>
            <td align="center" valign="top" style="font-family: 'Open Sans', sans-serif; font-size:18px; color:#2c2c2c; font-weight: 700;"><?php if(!empty($user_data->event_location)) echo $user_data->event_location; else echo'N/A'; ?></td>
          </tr>
          <tr>
            <td align="left" valign="top">&nbsp;</td>
          </tr>
          <tr>
            <td align="center" valign="top" style="font-family: 'Open Sans', sans-serif; font-size:16px; color:#ff8a00;">Ticket Id</td>
          </tr>
          <tr>
            <td align="center" valign="top" style="font-family: 'Open Sans', sans-serif; font-size:18px; color:#2c2c2c; font-weight: 700;"><?php if(!empty($user_data->event_id)) echo $user_data->event_id; else echo'N/A'; ?></td>
          </tr>
           <tr>
            <td align="left" valign="top">&nbsp;</td>
          </tr>
          ...
          <tr>
            <td align="center" valign="top" style="font-family: 'Open Sans', sans-serif; font-size:18px; color:#2c2c2c; font-weight: 700;"><?php if(!empty($user_data->guest_id)) echo $user_data->guest_id; else echo'N/A'; ?></td>
          </tr>
           <tr>
            <td align="left" valign="top">&nbsp;</td>
          </tr>
          ...
          <tr>
            <td align="center" valign="top" style="font-family: 'Open Sans', sans-serif; font-size:18px; color:#2c2c2c; font-weight: 700;"><?php if(!empty($user_data->event_time)) echo  date( 'g:i A', strtotime($user_data->event_time ) ); else echo'N/A'; ?></td>
          </tr>
            <tr>
            <td align="left" valign="top">&nbsp;</td>
          </tr>
          ...
          <tr>
            <td align="center" valign="top" style="font-family: 'Open Sans', sans-serif; font-size:18px; color:#2c2c2c; font-weight: 700;"><?php //if(!empty($user_data['ticket_id'])) echo $user_data['ticket_id']; else echo'N/A'; ?></td>
          </tr> -->
           <tr>
            <td align="left" valign="top">&nbsp;</td>
          </tr>
