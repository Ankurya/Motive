...
">
  ...
  <tr>
    ...
    border-bottom-left-radius: 29px;">
          ...
          <tr>
            <td align="left" valign="top" style="font-family: 'Open Sans', sans-serif; font-size:18px; color:#474747; font-weight: 700;text-align:center;">Hello, Motiv Enterpriseuk Mo Tiv</td>
          </tr>
           <tr>
          ...
          <tr>
            <td align="center" valign="top" style="font-family: 'Open Sans', sans-serif; font-size:18px; color:#2c2c2c;"><?php if(!empty($user_data->name)) echo $user_data->name; else echo'Facebook'; ?></td>
          </tr>
           <tr>
            <td align="left" valign="top">&nbsp;</td>
          </tr>
