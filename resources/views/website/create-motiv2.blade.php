    ...
    <div class="container">
        ...
        <div class="tabs">
                    ...
                    <div class="col-sm-8 col-sm-offset-2">
                        <div class="form-reflex create-moive alertsss">
                            ...
                            <div class="form-group new">
                                ...
                                <div class="col-sm-7">
                                    <div class="form-group images-first">
                                        <img onclick="$('#imgInp3').click()"  data-toggle="tooltip" title="Choose file" id="oldImg3" src="{{url('public/website/images/no-image.png')}}">
                                        <input type="file" id="imgInp3"  data-toggle="tooltip" title="Choose file" name="primary_image">
                                ...
                                <div class="col-sm-7 date">
                                  <div class="form-group">
                                    <div class='input-group date' id='datetimepicker1'>
                                      <input  placeholder="START DATE & TIME" value="{{old('start_date')}}" autocomplete="off" name="start_date" id="start_date" class="form-control" />
            ...
            <div class="form-group new">
                ...
                <div class="col-sm-7">
                    <input type="text" placeholder="AGE RESTRICTION" maxlength="2" value="{{old('age')}}" name="age" class="form-control">
            ...
            <div class="form-group  new margin-bottom-45">
                ...
                <div class="col-sm-7">
                    <textarea class="form-control" placeholder="DESCRIPTION" name="descriptions"></textarea>
            ...
            <div class="form-group  new margin-bottom-45">
                ...
                <div class="col-sm-7">
                    <a href="javascript:;" data-toggle="modal" data-target="#tickets-form">
...
<div class="modal" id="tickets-form">
  <div class="modal-dialog">
    <div class="modal-content" style="">
      ...
      <!-- Modal body -->
      <div class="modal-body ">
        <div style="padding:11px;font-weight: 400;" class="alert alert-success alert-dismissible text-center alertz test"></div>
        <div id="tab1" class="tab active">
          <div class="col-md-10 col-md-offset-1">
            <div class="form-reflex form-info-settings adit add-quantity">
                <div class="row">
                        ...
                        <div class="col-md-12">
                            <div class="new-tickets">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="ticket_title" maxlength="30" class="form-control" id="ticket_title" placeholder="TICKET TITLE">
                                    <span class="text-danger error ticket_title_error">{{$errors->first('ticket_title')}}</span>
                                </div>
                                <div class="form-group">
                                 <Label>TICKET DESCRIPTION</Label>

                                 <textarea class="form-control" name="ticket_description" maxlength="300" id="ticket_description" placeholder="TICKET DESCRIPTION"></textarea>
                                 <span class="text-danger error ticket_description_error"></span>
                             </div>
                             <div class="form-group">
                                <Label>TICKET AMOUNT</Label>
                                <input type="text" name="ticket_amount" maxlength="15" id="ticket_amount" class="form-control" placeholder="TICKET AMOUNT ">
                                <span class="text-danger error ticket_amount_error"></span>
                            </div>
                            <div class="form-group">
                                <Label>TICKET QUANTITY</Label>
                                <input type="text" class="form-control" maxlength="15" name="ticket_quantity" id="ticket_quantity" placeholder="TICKET QUANTITY">
                                <span class="text-danger error ticket_quantity_error"></span>
                            </div>
                            <div class="form-group">
                                <button type="button" onclick="return submit_form1();" class="btn btn-default register yes skip jack-new ticket">ADD</button>
                            </div>
                        </div>
                    </div>
                </form>
...
<script>
    ...
    $('#form_validate').validate({ // initialize the plugin
        ...
        messages:{
          ...
          dress_code:{  
              required:'Please select dress code.'
          },
          age:{  
              // required:'Please enter a age restriction.',
...
<script type="text/javascript">
  ...
  $.ajax({
      ...
      success: function(res){
        if(res.message) {
           $('#form_ticket')[0].reset();
            $('.ticket_title_error').hide();
            $('.ticket_description_error').hide();
            $('.ticket_amount_error').hide();
            $('.ticket_quantity_error').hide();
            $(".alertz").text(res.message).show();
        }
        setTimeout(function(){
            $(".alertz").hide();
        }, 5000);
    ...
    error: function(data, textStatus, xhr) {
        if(data.status == 422){
          ...
          var ticket_title_error = data.errors['ticket_title'] ? data.errors['ticket_title'] : 0;
            if (ticket_title_error) { 
                $('.ticket_title_error').html(ticket_title_error);
                $('.ticket_title_error').show();

           }else{
              $('.ticket_title_error').hide();
           }

          var ticket_description_error = data.errors['ticket_description'] ? data.errors['ticket_description'] : 0;
            if (ticket_description_error) { 
                $('.ticket_description_error').html(ticket_description_error);
                $('.ticket_description_error').show();

           }else{
              $('.ticket_description_error').hide();
           }

           var ticket_amount_error = data.errors['ticket_amount'] ? data.errors['ticket_amount'] : 0;

           if(ticket_amount_error) {
            $('.ticket_amount_error').html(ticket_amount_error);
            $('.ticket_amount_error').show();
           }else{
              $('.ticket_amount_error').hide();
           }

           var ticket_quantity_error = data.errors['ticket_quantity'] ? data.errors['ticket_quantity'] : 0;

           if(ticket_quantity_error){
            $('.ticket_quantity_error').html(ticket_quantity_error);
            $('.ticket_quantity_error').show();
           }else{
              $('.ticket_quantity_error').hide();
           }
