                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input type="password" autocomplete="off" name="password" class="form-control" placeholder="NEW PASSWORD">
                                ...
                                <div class="new-formula-home-sd">
                                    <button type="submit" class="new-homes">SUBMIT</button>
                                </div>
                            </form>
                            </div>
                        </div>
                    ...
                    <div class="col-md-12">
                        <div class="new-footer-contains text-center">
                           <ul>
                                ...
                                <li><a href="{{url('website/contact-us')}}"> Get in touch </a></li>
                                <li><a href="javascript:void(0);"> Faqs</a></li>
                                <li><a href="{{url('website/terms&conditions')}}"> terms & conditions</a></li>
