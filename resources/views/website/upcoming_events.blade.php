...
<div class="container">
   ...
   <div class="tabs events">
      ...
      <ul class="tab-links">
         <li id="button1"><a href="{{url('website/current-events')}}">Now</a></li>
         <li id="button2" class="active"><a href="javascript:void(0);">later</a></li>
         @if($user->role == 2)
      ...
      <div class="tab-content events">
         <div id="now" class="tab active">
            ...
            <div class="img-section jack events">
                     ...
                     <div class="col-sm-4">
                        ...
                        <div class="new-description">
                           ...
                           <div class="new-formula">
                              <h2>{{$event->event_date}} {{$event->event_time}}</h2>
                           </div>
                        </div>
               ...
               @if(!empty($upcoming_category) && $upcoming_category && count($upcoming_category)>0)
               <div class="first-element-section">
               ...
               @else 
               @endif
               @if($i == 0 && $j == 0 && count($upcoming_category) == 0)
...
<script type="text/javascript">
   $(document).on('click','.search',function(){
       ...
       // alert(search)
       if(search != '') {
           window.location = '{{url("website/search-upcoming")}}/'+search;
       } else {
           // window.location = '{{url("website/upcoming-events")}}';
       }
   });
</script>
<script type="text/javascript">
